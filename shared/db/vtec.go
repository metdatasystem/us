...
func FindCurrentVTECEventUGCsTX(tx pgx.Tx, ctx context.Context, wfo string, phenomena string, significance string, eventNumber int, year int, expires time.Time) ([]*models.VTECUGC, error) {
